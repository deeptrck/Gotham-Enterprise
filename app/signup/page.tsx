...
export default function Signup() {
  return (
    <div className="min-h-screen w-full max-w-5xl mx-auto flex items-center justify-center text-foreground px-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-2xl overflow-hidden border border-border shadow-background backdrop-blur-md bg-slate-50 dark:bg-card/30">
        ...
        <div className="w-full md:w-1/2 px-6 py-10 sm:px-10 md:p-14 space-y-6">
          <h2 className="text-3xl font-bold dark:text-stone-100">Create your account</h2>
          <p className="text-sm text-muted-foreground">
            Create your Deeptrack account through Auth0 secure authentication.
          </p>
          <a
